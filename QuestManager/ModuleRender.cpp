...
// Blit to screen
bool ModuleRender::Blit(SDL_Texture* texture, int x, int y, SDL_Rect* section,SDL_RendererFlip flip,bool useCamera,float multiplier, float speed, double angle, SDL_Point pivot)
{
	bool ret = true;
	SDL_Rect rect;
